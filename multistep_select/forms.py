...
class GenericRelationFormMixin(object):
    """ The django.contrib.contenttypes.generic.GenericForeignKey
        ...
        (ctype, id) 2-tuples returned by GenericRelationField's
        to_python method into individual values, and making sure the
        form passes them to the model as usual. """
    ...
    def clean(self):
        cleaned_data = super(GenericRelationFormMixin, self).clean()
